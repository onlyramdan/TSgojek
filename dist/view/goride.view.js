...
var RideView = /** @class */ (function () {
    function RideView(riderService, driverService, mainView, historyList) {
        this.riderService = riderService;
        this.driverService = driverService;
        this.mainView = mainView;
        this.historyList = historyList;
    }
    RideView.prototype.show = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        from = _a.apply(void 0, [_c.sent()]);
                        _b = String;
                        return [4 /*yield*/, (0, scanner_1.default)("to: ")];
                    case 2:
                        to = _b.apply(void 0, [_c.sent()]);
    ...
    RideView.prototype.askToDriver = function (from, to) {
        return __awaiter(this, void 0, void 0, function () {
            var option, _a;
    ...
    RideView.prototype.detailOrder = function (from, to) {
        return __awaiter(this, void 0, void 0, function () {
            var driver, price, invoice, type, history;
            return __generator(this, function (_a) {
                driver = this.driverService.findDriver();
                price = this.riderService.calculatepRrice(from, to);
                invoice = "RIDE-" + (0, generatorInvoice_1.default)();
                type = "RIDE";
                history = {
                    invoice: invoice,
                    type: type,
