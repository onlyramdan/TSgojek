...
var RestaurantServiceImpl = /** @class */ (function () {
    function RestaurantServiceImpl() {
    }
    RestaurantServiceImpl.prototype.findRestaurant = function () {
        var restaurants = this.addRestaurants();
        return restaurants;
    };
    RestaurantServiceImpl.prototype.addRestaurants = function () {
        var newRestaurants = [
            {
...
exports.default = RestaurantServiceImpl;
